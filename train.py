...
parser.add_argument('--initial_learning_rate', type=float, default=0.007,
...
def main(unused_argv):
  ...
  for _ in range(FLAGS.train_epochs // FLAGS.epochs_per_eval):
    tensors_to_log = {
      ...
      'constrained_focal_loss': 'constrained_focal_loss',
    ...
    init = tf.global_variables_initializer()
    tf.Session().run(init)
    #with tf.Session() as sess:                            #ok2
     # print(sess.run(valid_logits))	
