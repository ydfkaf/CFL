...
import constrained_focal_loss_impl
...
def deeplabv3_plus_model_fn(features, labels, mode, params):
  ...
  constrained_focal_loss=constrained_focal_loss(valid_labels, valid_logits,beita=2.0)                                          #
                                            #
  # Create a tensor named cross_entropy for logging purposes.
  tf.identity(constrained_focal_loss, name='constrained_focal_loss')                                                         #
  tf.summary.scalar('constrained_focal_loss', constrained_focal_loss)                                                            #
  ...
  with tf.variable_scope("total_loss"):
    loss = focal_class_imbalance_loss + params.get('weight_decay', _WEIGHT_DECAY) * tf.add_n(
